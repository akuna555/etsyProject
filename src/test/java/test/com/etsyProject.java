...
public class etsyProject {
  ...
  //  @Ignore
    @Test
    public void test1ChangeCurrency() throws InterruptedException {
    ...
    // @Ignore
     @Test
     public void test2ChangeRegion() throws InterruptedException {
         driver.findElement(By.xpath("//*[@id='settings']/div[2]/nav/ul/li[2]/a")).click();
   ...
   // @Ignore
     @Test
     public void test3NewPasswordNotMatch() throws InterruptedException{
    ...
    // @Ignore
     @Test
     public void test4CurrentPassInvalid() throws InterruptedException{
    ...
    // @Ignore
      @Test
     public void test5HelpCenterPage() {
    js.executeScript("window.scrollBy(0,1050)", "");
  ...
  //  @Ignore
    @Test
    public void test6LanguageChange() throws InterruptedException{
        driver.findElement(By.xpath("//*[@id='settings']/div[2]/nav/ul/li[2]/a")).click();
        Thread.sleep(2000);
